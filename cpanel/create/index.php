...
<meta name="twitter:description" content="Tulis dan bagikan resepm favoritmu agar dapat dilihat orang lain" />
    ...
    <body>
        ...
        <div class="container">
            <form id="survey-form" data-netlify="true" method="post" action="/php/create.php" enctype="multipart/form-data">
                <div class="form">
                ...
                <div class="form">
                    ...
                    <input type="text" id="asal" name="asal" class="control" placeholder="Minang, Jawa Ternate" />
                </div>
